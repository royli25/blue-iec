/*
  Student Profile Ingestion Script - Fixed CSV Parsing
  
  Usage:
    SUPABASE_URL=... \
    SUPABASE_SERVICE_ROLE_KEY=... \
    OPENAI_API_KEY=... \
    bun run tsx scripts/ingest_student_profiles_fixed.ts
...
async function main() {
  ...
  // Clear existing student profiles first
  console.log('Clearing existing student profiles...');
  ...
  if (deleteError) {
    console.error('Error clearing existing profiles:', deleteError);
  } else {
    console.log('Cleared existing student profiles');
  }
