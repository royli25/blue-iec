  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <div className="h-12 w-12 shrink-0 rounded-full bg-gradient-to-br from-indigo-200 via-purple-200 to-pink-200 shadow-inner">
          {avatarUrl ? (
        ...
        <div className="ml-auto">
          <button className="rounded-full bg-foreground px-3 py-1 text-xs font-medium text-primary-foreground shadow-sm hover:opacity-90">
            View
          </button>
        </div>
      </div>
